...
class Ui_dialog(object):
    def setupUi(self, dialog):
        ...
        dialog.resize(446, 407)
        self.buttonBox = QtWidgets.QDialogButtonBox(dialog)
        self.buttonBox.setGeometry(QtCore.QRect(80, 350, 341, 32))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 20, 401, 171))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 80, 381, 16))
        font = QtGui.QFont()
        ...
        self.tempChkBox.setGeometry(QtCore.QRect(50, 120, 141, 20))
        font = QtGui.QFont()
        ...
        self.dpGenChkBox.setGeometry(QtCore.QRect(50, 100, 211, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label3.setGeometry(QtCore.QRect(20, 40, 121, 21))
        font = QtGui.QFont()
        ...
        self.lineLC.setGeometry(QtCore.QRect(160, 37, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(20, 210, 401, 121))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tempChkBox_2 = QtWidgets.QCheckBox(self.groupBox_2)
        self.tempChkBox_2.setGeometry(QtCore.QRect(50, 80, 111, 17))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.tempChkBox_2.setFont(font)
        self.tempChkBox_2.setObjectName("tempChkBox_2")
        self.label4 = QtWidgets.QLabel(self.groupBox_2)
        self.label4.setGeometry(QtCore.QRect(20, 40, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.lineWVSS.setGeometry(QtCore.QRect(160, 40, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, dialog):
        ...
        self.tempChkBox_2.setText(_translate("dialog", "Use Pressure"))
