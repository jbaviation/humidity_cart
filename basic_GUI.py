...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CloseButton.setGeometry(QtCore.QRect(650, 620, 141, 61))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.CloseButton.setFont(font)
        self.CloseButton.setObjectName("CloseButton")
        self.lcLabel1 = QtWidgets.QLabel(self.centralwidget)
        self.lcLabel1.setGeometry(QtCore.QRect(60, 110, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lcLabel1.setFont(font)
        self.lcLabel1.setObjectName("lcLabel1")
        self.lcLabel2 = QtWidgets.QLabel(self.centralwidget)
        self.lcLabel2.setGeometry(QtCore.QRect(60, 360, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lcLabel2.setFont(font)
        self.lcLabel2.setObjectName("lcLabel2")
        self.lcLabel1_3 = QtWidgets.QLabel(self.centralwidget)
        self.lcLabel1_3.setGeometry(QtCore.QRect(60, 590, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lcLabel1_3.setFont(font)
        self.lcLabel1_3.setObjectName("lcLabel1_3")
        ...
        self.LiCorGroupBox.setGeometry(QtCore.QRect(579, 310, 181, 181))
        ...
        self.StopButton.setGeometry(QtCore.QRect(20, 130, 99, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.StartButton.setGeometry(QtCore.QRect(20, 100, 99, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.StartButton.setFont(font)
        self.StartButton.setObjectName("StartButton")
        self.HumGenLabel = QtWidgets.QLabel(self.LiCorGroupBox)
        self.HumGenLabel.setGeometry(QtCore.QRect(10, -6, 121, 101))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setUnderline(False)
        ...
        self.WVSSgroupBox.setGeometry(QtCore.QRect(779, 310, 171, 181))
        ...
        self.WVSSstartButton.setGeometry(QtCore.QRect(20, 100, 82, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.WVSSstopButton.setGeometry(QtCore.QRect(20, 130, 82, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.WVSSLabel.setGeometry(QtCore.QRect(10, -6, 121, 101))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setUnderline(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lcLabel1.setText(_translate("MainWindow", "LiCor:"))
        self.lcLabel2.setText(_translate("MainWindow", "LiCor:"))
        self.lcLabel1_3.setText(_translate("MainWindow", "LiCor:"))
        ...
        self.HumGenLabel.setText(_translate("MainWindow", "LiCor Humidity Generator"))
        self.WVSSstartButton.setText(_translate("MainWindow", "Scan"))
        self.WVSSstopButton.setText(_translate("MainWindow", "Stop"))
        self.WVSSLabel.setText(_translate("MainWindow", "WVSS Spectra Sensor"))
